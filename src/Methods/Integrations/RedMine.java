...
public class RedMine {
    public  void addredmine(WebDriver driver){
        ...
        driver.findElement(By.xpath("//div[@id='myModal']/div/div/div/div/div/ul/li[6]/a/label")).click();
        driver.findElement(By.id("redmine_setting_base_url")).click();
        driver.findElement(By.id("redmine_setting_base_url")).clear();
        driver.findElement(By.id("redmine_setting_base_url")).sendKeys("base_url 'http://thinktest.m.redmine.org/'");
        driver.findElement(By.id("redmine_setting_base_url")).click();
        driver.findElement(By.id("redmine_setting_base_url")).clear();
